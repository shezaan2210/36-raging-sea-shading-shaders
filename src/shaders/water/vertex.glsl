...
void main()
{
    ...
    vec3 neighbourA  = modelPosition.xyz + vec3(shift, 0.0, 0.0);
    vec3 neighbourB  = modelPosition.xyz + vec3(0.0, 0.0, - shift);
    ...
    // compute normals
    vec3 toA = normalize(neighbourA - modelPosition.xyz);
    vec3 toB = normalize(neighbourB - modelPosition.xyz);
